...
import { Trophy, Calendar, MapPin, Users, ChevronDown, ChevronUp, CheckCircle, Clock, AlertCircle } from 'lucide-react'
        ...
        <div style={{ borderTop: '1px solid #f1f5f9', padding: '1.25rem 1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', marginBottom: '1.25rem' }}>
            <div style={{ background: '#f8fafc', borderRadius: '0.625rem', padding: '0.625rem 1rem', fontSize: '0.875rem' }}>
              ...
              <span style={{ fontWeight: 700, color: '#0f172a' }}>{t.price ? `$${t.price}` : 'Gratuit'}</span>
            </div>
            {t.maxPlayers && (
              <div style={{ background: '#f8fafc', borderRadius: '0.625rem', padding: '0.625rem 1rem', fontSize: '0.875rem' }}>
            ...
            <>
              ...
              {!user ? (
                ...
                <button
                  ...
                  style={{ background: 'linear-gradient(135deg, #b45309, #d97706)', color: '#fff', border: 'none', padding: '0.875rem 2rem', borderRadius: '0.75rem', fontWeight: 700, fontSize: '1rem', cursor: registering === t.id ? 'not-allowed' : 'pointer', opacity: registering === t.id ? 0.7 : 1, display: 'flex', alignItems: 'center', gap: '0.5rem' }}
                >
                  <Trophy size={16} /> {registering === t.id ? 'Inscription…' : "S'inscrire au tournoi"}
                </button>
              )}
            </>
          )}
